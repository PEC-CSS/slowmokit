 ...
 * @param testSize: proportion of the dataset to be included in the test split. Default value: 0.3
 * @param trainSize: proportion of the dataset to be included in the test split. Default value: 0.7
